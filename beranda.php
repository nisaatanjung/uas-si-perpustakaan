    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Sistem Informasi Perpustakaan STMIK Royal Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Kode Buku</th><th>Judul</th><th>Penulis</th><th>Penerbit</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
